package io.kettil.faasenvoyinit;
...
@Slf4j
public class FaasEnvoyInitApplication implements Callable<Integer> {
    ...
    public static void main(String[] args) {
        int exitCode = new picocli.CommandLine(new FaasEnvoyInitApplication())
            .execute(args);
